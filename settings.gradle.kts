...
// Composite consumers only need the libraries. Keeping demos out of that build avoids forcing
// the consumer's Gradle version onto unrelated Android sample plugins.
if (!libraryOnly) {
